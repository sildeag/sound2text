...
import com.sildeag.sound2text.uilegacy.service.recognizer.MockMicRecognizer
...
singleton: object TestModules {
    ...
    val recognizerMock = module(override = true) {
        single<Recognizer> { _root_ide_package_.com.sildeag.sound2text.uilegacy.service.recognizer.MockMicRecognizer() }
    }
