package com.sildeag.sound2text.uidesktop.fxml
...
private val prefs = Preferences.userNodeForPackage(_root_ide_package_.com.sildeag.sound2text.uidesktop.fxml.SoundScreen::class.java)
            ...
            parametersOf(
                SoundViewModelParams(
                    ...
                    fun onResetSensitivity(event: ActionEvent) {
                        ...
                        _root_ide_package_.com.sildeag.sound2text.uidesktop.fxml.prefs.putDouble("micSensitivity", defaultValue)
                    }
                    ...
                    fun onRestoreDefaults(event: ActionEvent) {
                        ...
                        _root_ide_package_.com.sildeag.sound2text.uidesktop.fxml.prefs.putDouble("micSensitivity", defaultSensitivity)

                        // 🔔 Reset sound toggle
                        soundToggle.isSelected = true
                        _root_ide_package_.com.sildeag.sound2text.uidesktop.fxml.prefs.putBoolean("soundEnabled", true)
                    }
