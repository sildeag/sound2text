package com.sildeag.sound2text.uidesktop.service.logic
...
class PulseLogicTest : com.sildeag.sound2text.test.KoinTestHarness(
    ...
    moduleOverrides = {
        includes(_root_ide_package_.com.sildeag.sound2text.uidesktop.di.TestModules.pulseLogicTest)
        includes(_root_ide_package_.com.sildeag.sound2text.uidesktop.di.TestModules.recognizerMock)
        includes(_root_ide_package_.com.sildeag.sound2text.uidesktop.di.TestModules.noteEditorMock)
        includes(_root_ide_package_.com.sildeag.sound2text.uidesktop.di.TestModules.callbackMocks)
    }
)
