package com.sildeag.sound2text.uilegacy.service.logic

import com.sildeag.sound2text.core.config.Environment
import com.sildeag.sound2text.di.PulseLogicParams
import com.sildeag.sound2text.uilegacy.di.TestModules
...
class PulseLogicTest : com.sildeag.sound2text.test.KoinTestHarness(
    environment = Environment.TEST,
    moduleOverrides = {
        includes(_root_ide_package_.com.sildeag.sound2text.uilegacy.di.TestModules.pulseLogicTest)
        includes(_root_ide_package_.com.sildeag.sound2text.uilegacy.di.TestModules.recognizerMock)
        includes(_root_ide_package_.com.sildeag.sound2text.uilegacy.di.TestModules.noteEditorMock)
        includes(_root_ide_package_.com.sildeag.sound2text.uilegacy.di.TestModules.callbackMocks)
    }
)
